...
SELECT DISTINCT CONCAT_WS(" ", m.firstname, m.surname) AS member, f.name
FROM Bookings AS b
...
WHERE starttime LIKE "%2012-09-14%"
	  AND ((memid = 0 AND b.slots * f.guestcost > 30)
           OR (memid <> 0 AND b.slots * f.membercost > 30))
ORDER BY cost DESC;
